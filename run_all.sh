...
concurrent_users=(300 200 150 100 50 10)
...
run_jmeter() {
    ...
    ss -s > results/$1/jmeter_ss.txt
    ssh $ei_ssh_host "ss -s" > results/$1/ei_ss.txt
    ssh $activemq_ssh_host "ss -s" > results/$1/activemq_ss.txt
}
